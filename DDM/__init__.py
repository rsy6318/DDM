...
class P2F_dist(torch.nn.Module):
    ...
    def forward(self,points, vertices, faces):
        ...
        f2=vertices[f2_idx]
        f3=vertices[f3_idx]
        indexes,w1,w2,w3=closestPointonSurface.forward(points,f1,f2,f3)
...
class DDM_M2M(torch.nn.Module):
    ...
    def forward(self,src_v,src_f,tgt_v,tgt_f):
        #src_mesh, tgt_mesh: pytorch3d.structures.Meshes
        #src_v, tgt_v   [N,3]
        ...
        #query_points,_=sampl_surface(tgt_f,tgt_v,self.n_query)
        #noise_offset=torch.randn_like(query_points)*0.01
        #query_points=query_points+noise_offset
        ...
        src_indexes,src_w1,src_w2,src_w3=closestPointonSurface.forward(query_points,src_f1,src_f2,src_f3)
        tgt_indexes,tgt_w1,tgt_w2,tgt_w3=closestPointonSurface.forward(query_points,tgt_f1,tgt_f2,tgt_f3)
